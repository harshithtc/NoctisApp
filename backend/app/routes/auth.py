...
router = APIRouter(tags=["Authentication"])  # No prefix; handled in __init__.py
...
async def login(
    ...
    try:
        ...
        # Uncomment for email verification enforcement
...
async def logout(
    ...
    try:
        ...
        # In production: add token invalidation, etc.
        return {
